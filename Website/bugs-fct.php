                  ...
                  <div class="row mt-3 db-chart">
                     <div id="parent1" class="col-lg-6 col-xl-3 column">
                        <div class="chart-card mb-4">
                           <div id="gauge1" class="chart-title">Total FCT Bugs</div>
                              ...
                              <thead>
                                 <tr>
                                    <th colspan="7" class="tableMainHeading">
                                       <center <label id="bugsReviewTableHeaderRow">FCT Bugs Review Summary</label>
                                       </center>
                                    </th>
                                 </tr>
                                 <tr>
                     ...
                     <ul>
                        ...
                        <li>
                           ...
                           <ul>
                              ...
                              <li>P2: Resolve within 24 clock hours (excluding weekends)</li>
                              <li>P3: Resolve within 24 clock hours (excluding weekends)</li>
                           </ul>
                        </li>
                     </ul>
                  </div>
