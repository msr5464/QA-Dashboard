         ...
         <div data-reactroot="">
            <div class="container-fluid">
               <div class="row flex-xl-nowrap">
                  <?php
                     $activateFctTestsAutoPage = "active";
                     ...
                     <div class="row mt-3 db-chart">
                        <div id="parent1" class="col-lg-6 col-xl-4 column">
                           <div class="chart-card mb-4">
                              <div class="chart-title" id="text2">FCT Automation Coverage</div>
                        ...
                        <div id="parent2" class="col-lg-6 col-xl-4 column">
                           <div class="chart-card mb-4">
                              <div class="chart-title" id="text2">P0 FCT Automation</div>
                        ...
                        <div id="parent3" class="col-lg-6 col-xl-4 column">
                           <div class="chart-card mb-4">
                              <div class="chart-title" id="text2">P1 FCT Automation</div>
