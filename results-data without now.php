  ...
  if (!isset($jsonArray['error'])) 
  {
    switch ($_GET['functionname']) 
    {
      case 'getAvgPercentage':
        ...
        $sql = "select projectName,round(AVG(percentage),0) as percentage from results where environment='".$_GET['arguments'][1]."' and createdAt>=DATE_SUB((select createdAt from results where environment='".$_GET['arguments'][1]."' order by id desc limit 1), INTERVAL ".$_GET['arguments'][0]." DAY) group by projectName order by projectName desc;";
      ...
      case 'getAvgPercentage_Project':
        ...
        $sql = "select environment,round(AVG(percentage),0) as percentage from results where projectName='".$_GET['arguments'][0]."' and createdAt>=DATE_SUB((select createdAt from results where projectName='".$_GET['arguments'][0]."' order by id desc limit 1), INTERVAL ".$_GET['arguments'][1]." DAY) group by environment;";
      ...
      case 'getDailyAvgPercentage_Project':
        ...
        $sql = "SELECT  DATE(createdAt) as createdAt, avg(percentage) as percentage, environment FROM `results` WHERE projectName='".$_GET['arguments'][0]."' and createdAt>=DATE_SUB((select createdAt from results order by id desc limit 1), INTERVAL ".$_GET['arguments'][1]." DAY) GROUP BY DATE(createdAt),environment;";
...
case 'getTotalCasesGroupwise_Project':
        ...
        $jsonArraySubSet2 = array();
        $jsonArraySubSet3 = array();
        $sql = "SELECT  DATE(createdAt) as createdAt, max(totalCases) as totalCases, groupName FROM `results` WHERE projectName='".$_GET['arguments'][0]."' and createdAt>=DATE_SUB((select createdAt from results where projectName='".$_GET['arguments'][0]."' order by id desc limit 1), INTERVAL ".$_GET['arguments'][1]." DAY) GROUP BY DATE(createdAt),groupName;";
