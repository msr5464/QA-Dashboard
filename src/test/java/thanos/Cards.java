...
public class Cards extends TestBase
{
	...
	String teamName = "Cards";
	
	@Test(priority = 2, dataProvider = "getTestConfig", description = "Fetch Only FCT testcases from the TestRail", groups = { "dataPopulator" })
	...
	@Test(priority = 3, dataProvider = "getTestConfig", description = "Fetch All the testcases from the TestRail", groups = { "dataPopulator" })
	...
	@Test(priority = 1, dataProvider = "getTestConfig", description = "Fetch tickets tested and ALL bugs from Jira using unified approach", groups = {"dataPopulator" })
	...
	@Test(priority = 4, dataProvider = "getTestConfig", description = "Code for calculating Vertical level and Entity level data", groups = {"dataPopulator" })
